...
import FilaCentroEscolar from '../Filas/FilaCentroEscolar';
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    <Card>
                        <h4 className="text-center">Centros Escolares</h4>
                        <CardBody>
                            <Table responsive>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    {this.props.currPage &&
                                        this.props.currPage.data.map(
                                            (user, i) => (
                                                <FilaCentroEscolar key={i} user={user} refresh={this.refresh} cargar={this.cargar} notify={this.notify} />
                                            )
                                        )}
                                </tbody>
                            </Table>
